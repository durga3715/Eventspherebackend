...
import com.example.eventsphere.services.userservice;
...
public class usercontroller {
    ...
    @PutMapping("/{id}")
    public user updatedata(@PathVariable int id, @RequestBody user data) {
    ...
    @PatchMapping("/{id}")
    public user patchData(@PathVariable int id, @RequestBody user data) {
